        ...
        <li className="flex items-center mb-5 ms-6 w-full">
          ...
          >
            <div className="flex gap-2 items-center w-full justify-between">
              ...
              <div className="w-full">Best Caterer - Up to 50 Hackers</div>
        ...
        <li className="mb-5 ms-6 w-full">
          ...
          >
            <div className="flex gap-2 items-center w-full justify-between">
              ...
              <div className="w-full">Good Caterer - Up to 30 Hackers</div>
        ...
        <li className="ms-6 w-full">
          ...
          >
            <div className="flex gap-2 items-center w-full justify-between">
              ...
              <div className="w-full">Average Caterer - Up to 10 Hackers</div>
